...
class ProductService {
  ...
  /**
   * Compensating action for reserveStock - used by order-service when
   * it needs to roll back a reservation because a later step in
   * placing an order failed. See order.service.js's #compensate().
   */
